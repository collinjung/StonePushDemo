...
red_stone_pos = [3, 3]
green_stone_pos = [4, 2]
purple_stone_pos = [9, 1]
goal_red_space = [11, 1]
goal_green_space = [11, 3]
goal_purple_space = [11, 5]
...
stones = {
    ...
    "purple": purple_stone_pos.copy()
}

goals = {
    "goal_red": goal_red_space,
    "goal_green": goal_green_space,
    "goal_purple": goal_purple_space
}
...
def draw_goals():
    colors = {"goal_red": RED, "goal_green": GREEN, "goal_purple": PURPLE}
...
def check_success():
    ...
    if (stones["red"] == goals["goal_red"] and
        stones["green"] == goals["goal_green"] and
        stones["purple"] == goals["goal_purple"]):
        game_over = True
        announce_success()
